      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-black text-white text-[14px] font-medium rounded-xl hover:bg-zinc-800 transition-colors shadow-lg shadow-black/5"
          >
            <Plus size={15} />
            Add Company
          </button>
            ...
            {companies.map((company, index) => (
              ...
              >
                <button
                  ...
                  className="w-full text-left bg-white/90 backdrop-blur-sm rounded-2xl border border-zinc-200/80 p-6 hover:border-zinc-300 hover:shadow-lg hover:shadow-zinc-200/50 hover:-translate-y-0.5 transition-all duration-300 group"
                >
